...
resnet_v1_101_caffe_to_tf = {
  ...
  'res2a_branch1':        'resnet_v1_101/block1/unit_1/bottleneck_v1/shortcut/Relu',
  ...
  'res2a':                'resnet_v1_101/block1/unit_2/bottleneck_v1/Relu',
  ...
  'res3a_branch1':        'resnet_v1_101/block2/unit_1/bottleneck_v1/shortcut/Relu',
  ...
  'res4a_branch1':        'resnet_v1_101/block3/unit_1/bottleneck_v1/shortcut/weights',
  ...
  'res5a_branch1':        'resnet_v1_101/block4/unit_1/bottleneck_v1/shortcut/weights',
        ...
        with eval_graph.as_default():            
            ...
            for n in tf.get_default_graph().as_graph_def().node:
                if n.name in resnet_v1_101_tf_to_caffe:
                    print("add caffe resnet layer:", n.name)
                    layer_name = resnet_v1_101_tf_to_caffe[n.name]
                    name = n.name                        
                    v = get_tensor("{}:0".format(name))                    
                    params[layer_name] = v
